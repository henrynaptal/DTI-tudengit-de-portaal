...
<head>
    ...
    <link rel="stylesheet" href="mata.css">
...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-12 text-center">
                ...
                <h1 class="animate-character">Matemaatika, Majandusmatemaatika Ja Andmeanalüüs</h1>
    ...
    <header>
        ...
        <a href="../../avaleht.html" class="logo"><img src="../../pics/tlü.png" alt="pilt"></a>
